                ...
                <div class="mainForm">
                    <form action="core/handleForms.php?applicant_id=<?php echo $_GET['applicant_id']; ?>" method="POST">
                        ...
                        <p>
                            ...
                            <input type="date" name="date_added" value="<?php echo $getUserByID['date_added']; ?>"
                                required>
                        </p>
                        <p>
                            <label for="firstName">Phone Number</label>
                            <input type="text" name="phone_number" value="<?php echo $getUserByID['phone_number']; ?>"
                                required>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <input type="text" name="certifications"
                                value="<?php echo $getUserByID['certifications']; ?>" required>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <input type="number" name="desired_salary"
                                value="<?php echo $getUserByID['desired_salary']; ?>" min="10000" max="99999999"
                                required>
                        </p>
                </div>
            </div>
